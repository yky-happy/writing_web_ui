      ...
      <div id = "content">
        ...
        <el-row justify = "space-between" type = "flex">
          <el-col :span = "11" class = "item flex-model">
            ...
            <div class = "btn-box">
              <a class = "btn" href = "/effidit-v0.2.0-zh-setup.msi" target = "_blank">
                <p>立即下载</p>
              </a>
            </div>
          </el-col>
